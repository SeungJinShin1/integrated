...
const NODE_POSITIONS = [
  ...
  { left: '29.5%', top: '62.5%' }, // stage-2 폭탄이 터졌다 — 12시 1.5% ↑
  { left: '60%', top: '27%' }, // stage-3 기차는 멈추지 않아 — 6시 1.5% ↓
  { left: '67.5%', top: '52%' }, // stage-4 사라진 퍼즐 조각
  { left: '52%', top: '82.5%' }, // stage-5 갈림길의 기억 — 12시 1.5% ↑
  { left: '87%', top: '70%' }, // stage-6 빛나는 우리 반 — 12시 2% ↑
];
