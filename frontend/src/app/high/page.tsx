...
const NODE_POSITIONS = [
  { left: '18%', top: '32%' }, // stage-1 앵무새의 숲 — 6시 1.5% ↓
  { left: '29.5%', top: '61.5%' }, // stage-2 폭탄이 터졌다 — 12시 1% ↑
  { left: '60%', top: '27%' }, // stage-3 기차는 멈추지 않아
  { left: '67.5%', top: '51%' }, // stage-4 사라진 퍼즐 조각 — 12시 1% ↑
  { left: '52%', top: '82.5%' }, // stage-5 갈림길의 기억
  { left: '87%', top: '69%' }, // stage-6 빛나는 우리 반 — 12시 1% ↑
];
